...
簡易的なGitHubクライアントアプリの開発を通して、SwiftUIを使ったiOSアプリ開発の基礎知識と実務スキルを身に付けるための研修です。iOSアプリ開発未経験者でもSwift言語の基礎から学んでいけるように構成されています。各セクションはそれぞれブランチに分かれていて、セクションごとの差分を確認することができます。
